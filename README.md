...
Статус: пройден
# Тест-Кейс №4
Найти определенный товар и добавить его в корзину

Предусловие: пользователь зарегистрирован и авторизован

Входные данные: товар - dress
...
# Тест-Кейс №10
Найти определенный товар, используя фильтры на странице special edition

Предусловие: отсутствует

Входные данные: colour - black, type of product - dress
